...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-50 bg-gradient-to-r from-green-600 to-green-800 text-white shadow-lg">
        <div className="container mx-auto flex items-center justify-between p-4">
          {/* Logo */}
          <div className="flex items-center space-x-2">
            <Home className="h-6 w-6 text-white" />
            <h1 className="text-xl font-bold">South Bay Garage Door</h1>
          </div>
...
//         {/* Mobile Nav */}
//         {mobileMenuOpen && (
//           <nav className="md:hidden bg-gradient-to-r from-green-600 to-green-800 border-t border-green-700">
//             <div className="container mx-auto flex flex-col space-y-2 p-4">
//               {navItems.map((item) => (
//                 <Button
//                   key={item.id}
