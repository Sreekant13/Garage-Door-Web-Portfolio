    ...
    <footer className="bg-neutral-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-inter font-semibold">South Bay Garage Door</h3>
            </div>
        ...
        <div className="border-t border-neutral-700 mt-8 pt-8 text-center text-sm text-neutral-400">
          <p>
            &copy; 2010{currentYear > 2010 ? `–${currentYear}` : ""} Repair Broken Garage Door. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
