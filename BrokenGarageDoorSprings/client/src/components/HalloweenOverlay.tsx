...
<div className="fixed inset-0 pointer-events-none z-[60] overflow-hidden">
  ...
  {/* === FOG + GLOW FLOOR === */}
  <div className="absolute bottom-0 left-0 w-full h-40 opacity-70 pointer-events-none"
     style={{
       background: 'radial-gradient(80% 60% at 50% 100%, rgba(255,255,255,0.35) 0%, rgba(255,255,255,0.15) 40%, rgba(255,255,255,0) 70%)',
       filter: 'blur(6px)',
