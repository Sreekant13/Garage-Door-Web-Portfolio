...
import slide1 from "../assets/images/agourahills.png";
import slide2 from "../assets/images/agourahills1.png";
import slide3 from "../assets/images/agourahills2.png";
import slide4 from "../assets/images/agourahills3.png";
...
function getHolidayImage() {
  ...
  const ranges = [
    ...
    // NOTE: your original ranges overlap here (09-13..10-06 + 09-07..09-17).
    // Keeping as-is to match Granada Hills behavior.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Garage Door Repair{" "}
              <span className="text-phone-highlight">Agoura Hills</span>
            </h1>

            <p className="text-xl mb-8 text-gray-100">
              Fast, affordable, and reliable garage door repair services. We
              repair all makes and models of garage doors, garage door openers,
              and garage door springs for over 47 years.
            </p>
