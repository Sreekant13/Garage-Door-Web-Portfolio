...
import slide1 from "../assets/images/sealbeach.png";
import slide2 from "../assets/images/sealbeach1.png";
import slide3 from "../assets/images/sealbeach2.png";
import slide4 from "../assets/images/sealbeach3.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Garage Door Repair{" "}
              <span className="text-phone-highlight">Seal Beach</span>
            </h1>
