...
import slide1 from "../assets/images/granadahills.png";
import slide2 from "../assets/images/granadahills1.png";
import slide3 from "../assets/images/granadahills2.png";
import slide4 from "../assets/images/granadahills3.png";
...
export default function HeroSection() {
  ...
  // slideshow state
  const slides = [holidayImage, slide1, slide2, slide3, slide4];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Garage Door Repair{" "}
              <span className="text-phone-highlight">Granada Hills</span>
            </h1>
