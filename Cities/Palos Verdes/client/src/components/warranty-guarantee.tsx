...
const guarantees = [
  ...
  },
  {
    ...
    description: "Nearly five decades of professional garage door repair expertise in Palos Verdes and anyone who lives here knows what good work I do. Glad to be recognized as one of the most reliable garage door companies that services Palos Verdes."
  },
  {
    icon: ThumbsUp,
