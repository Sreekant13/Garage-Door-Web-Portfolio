...
import slide1 from "../assets/images/woodlandhills.png";
import slide2 from "../assets/images/woodlandhills1.png";
import slide3 from "../assets/images/woodlandhills2.png";
import slide4 from "../assets/images/woodlandhills3.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Garage Door Repair{" "}
              <span className="text-phone-highlight">Woodland Hills</span>
            </h1>
