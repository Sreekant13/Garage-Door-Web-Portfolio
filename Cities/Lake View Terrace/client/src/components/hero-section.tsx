...
import slide1 from "../assets/images/lakeviewterrace.png";
import slide2 from "../assets/images/lakeviewterrace1.png";
import slide3 from "../assets/images/lakeviewterrace2.png";
import slide4 from "../assets/images/lakeviewterrace3.png";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Garage Door Repair{" "}
              <span className="text-phone-highlight">Lake View Terrace</span>
            </h1>
