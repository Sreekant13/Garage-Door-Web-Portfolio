...
const guarantees = [
  ...
  },
  {
    ...
    description: "Nearly five decades of professional garage door repair expertise in Westwood and anyone who lives here knows what good work I do. Glad to be recognized as one of the most reliable garage door companies that services Westwood."
  },
  {
    icon: ThumbsUp,
