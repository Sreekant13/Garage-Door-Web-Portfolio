...
const losAngelesAreas = [
  "Rossmoor","Santa Fe Springs","Long Beach","Lakewood",
  "Bellflower","Cerritos","Norwalk","Paramount",
];

const orangeCountyAreas = [
  "Seal Beach","Anaheim","Fullerton","Huntington Beach",
  "Garden Grove","Costa Mesa","Orange","Westminster",
];
...
// import area   from "../assets/images/serviceareaimage.png";
// import area1  from "../assets/images/serviceareaimage1.png";
// import area2  from "../assets/images/serviceareaimage2.png";
// import area3  from "../assets/images/serviceareaimage3.png";
// import area4  from "../assets/images/serviceareaimage4.png";
...
// const slides = [area, area1, area2, area3, area4, area5];
...
// // import { Card, CardContent } from "@/components/ui/card";
// // import image from "../assets/images/serviceareaimage.png"
// // const losAngelesAreas = [
// //   "Rossmoor", "Santa Fe Springs", "Long Beach", "Lakewood", 
// //   "Bellflower", "Cerritos", "Norwalk", "Paramount"
// // ];
...
// //           transition={{ duration: 0.6 }}
// //         >
// //           <h2 className="text-4xl font-bold text-professional mb-4">Service Areas</h2>
// //           <p className="text-xl text-gray-600">Providing garage door repair services throughout Southern California</p>
// //         </motion.div>
...
// //           >
// //             <img 
// //               src="https://images.unsplash.com/photo-1524661135-423995f22d0b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600" 
// //               alt="Service area map of Southern California" 
...
// //             <Card className="p-8 shadow-lg">
// //               <CardContent className="p-0">
// //                 <h3 className="text-2xl font-bold text-professional mb-6">Primary Service Areas</h3>
// //                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600">
// //                   <div className="space-y-2">
// //                     <p className="font-semibold text-emergency">Los Angeles County:</p>
...
// //                   </div>
// //                   <div className="space-y-2">
// //                     <p className="font-semibold text-emergency">Orange County:</p>
// //                     <ul className="space-y-1 text-sm">
// //                       {orangeCountyAreas.map((area) => (
// //                         <li key={area}>• {area}</li>
// //                       ))}
...
// //                 >
// //                   <div className="bg-phone-highlight p-4 rounded-lg border-2 border-urgent">
// //                     <p className="font-bold text-emergency mb-2">CALL FOR SERVICE IN YOUR AREA</p>
// //                     <a 
// //                       href="tel:562-506-1384" 
// //                       className="text-3xl font-bold text-professional hover:text-emergency transition-colors"
// //                     >
