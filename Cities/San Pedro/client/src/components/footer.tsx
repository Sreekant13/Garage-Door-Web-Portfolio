    ...
    <footer className="bg-professional text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <h3 className="text-2xl font-bold mb-4">Garage Door Repair San Pedro</h3>
            <p className="text-gray-300 mb-4">
              Joseph Lucey has been providing reliable garage door repair services in San Pedro and surrounding areas for over 47 years.
            </p>
            <motion.div 
          ...
          >
            ...
            <div className="text-gray-300 space-y-2">
              <p className="flex items-center">
                ...
                Serving San Pedro & Surrounding Areas
              </p>
              <p className="flex items-center">
        ...
        <div className="text-center text-gray-400">
          <p>&copy; 2025 Garage Door Repair San Pedro. All Rights Reserved.</p>
          <p className="mt-2 text-sm">
            Garage Door Repair San Pedro | San Pedro Garage Door Repair | New Garage Door Opener San Pedro | San Pedro Garage Door Springs | San Pedro Garage Door Springs
          </p>
        </div>
      </div>
    </footer>
