...
// // 🎉 SAME HOLIDAY FUNCTION AS OFFICIAL GENIE
// function getHolidayImage() {
//   const today = new Date();
//   const month = today.getMonth() + 1;
//   const day = today.getDate();
...
//       <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 px-4 py-20 lg:py-32 gap-10">
...
//             animate={{ opacity: 1, y: 0 }}
//           >
//             WE OUTSELL THEM ALL. 47 YEARS IN BUSINESS <br />
...
//           >
//             {brands.map((brand) => (
//               <div key={brand.name} className="bg-white/20 backdrop-blur-sm px-5 py-2 rounded-lg">
//                 <svg width={brand.width} height={40} viewBox={`0 0 ${brand.width} 40`}>
//                   <text x="50%" y="50%" dy="0.35em" fontFamily="Arial" fontSize="14" fontWeight="bold" fill="white" textAnchor="middle">
//                     {brand.name}
//                   </text>
//                 </svg>
//               </div>
...
//           >
//             {phoneNumbers.map((p) => (
//               <a key={p.number} href={`tel:${p.number}`} className="bg-green-500 text-white px-4 py-6 rounded-xl shadow-lg text-center hover:bg-green-600">
//                 <div className="text-2xl">📞</div>
//                 <div className="font-bold text-lg">{p.number}</div>
//                 <div className="text-sm text-gray-100">{p.area}</div>
//               </a>
//             ))}
//           </motion.div>
...
//           <img
//             src={getHolidayImage()}
//             className="rounded-xl shadow-xl w-full max-w-[400px] md:max-w-[500px]"
//             alt="Holiday"
//           />
//         </div>
