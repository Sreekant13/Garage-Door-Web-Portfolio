      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-300 mb-4">
              Joseph Lucey has been providing reliable garage door repair services in Rossmoor and surrounding areas for over 47 years.
            </p>
            <motion.div 
          ...
          >
            ...
            <div className="text-gray-300 space-y-2">
              <p className="flex items-center">
                ...
                Serving Rossmoor & Surrounding Areas
              </p>
              <p className="flex items-center">
        ...
        <div className="text-center text-gray-400">
          ...
          <p className="mt-2 text-sm">
            Garage Door Repair Rossmoor | Rossmoor Garage Door Repair | New Garage Door Opener Rossmoor | Rossmoor Garage Door Springs | Rossmoor Garage Door Springs
          </p>
        </div>
      </div>
    </footer>
