    ...
    <div className="space-y-6">
        <div className="space-y-4">
          <h1 className="text-4xl font-bold text-green-900">
            New Garage Door Springs – Santa Monica
          </h1>
      ...
      <h2 className="text-2xl font-semibold text-green-800 mb-4 border-l-4 border-green-600 pl-4">New Garage Door Openers – Santa Monica</h2>
      ...
      <h2 className="text-2xl font-semibold text-green-800 mb-4 border-l-4 border-green-600 pl-4">Garage Door Openers and Garage Doors – Santa Monica</h2>
      ...
      <h2 className="text-2xl font-semibold text-green-800 mb-4 border-l-4 border-green-600 pl-4">Garage Door Repair – Santa Monica</h2>
...
<div className="flex flex-wrap justify-center mb-8 space-x-4">
  {[motor1, motor2, motor3].map((src, idx) => (
    ...
    >
      ...
      <h2 className="text-2xl font-semibold text-green-800 mb-4 border-l-4 border-green-600 pl-4">Electric Gate Openers – Santa Monica</h2>
