      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-200 max-w-2xl mx-auto">
            We proudly serve Santa Monica and surrounding areas for over {' '}
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300 mb-4">Serving Santa Monica, San Fernando Valley, Orange County and surrounding areas</p>
          <button
