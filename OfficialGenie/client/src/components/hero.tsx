...
import bgImg from '../assets/images/genie1.png';
import featureImg from '../assets/images/GeniePP.png';
import { Phone, Home, Battery, Shield, Wifi, VolumeX, ChevronDown as ArrowDown } from 'lucide-react';
...
import turkeyCursor from "@/assets/images/turkey-cursor.png"; 
...
function getHolidayImage() {
  ...
  for (const r of ranges) {
    ...
    // Handle cross-year ranges (e.g., Dec 28 - Jan 6)
    if (startNum > endNum) {
  ...
  return halloweenImg; // Default fallback
}
...
function isThanksgiving() {
  ...
  // Your Thanksgiving window: Nov 03–30
...
export default function Hero() {
  return (
    <section
      id="hero"
        className="
        scroll-mt-24 relative bg-black bg-contain bg-no-repeat bg-center
        flex items-center
        min-h-[calc(100dvh-80px)]   /* use dvh + your header height (≈ pt-24 = 96px) */
        -mb-px                      /* remove 1px hairline gap at bottom */
      "
      style={{ 
        backgroundImage: `url(${bgImg})`, 
        cursor: isThanksgiving()
           ? `url(${turkeyCursor}) 16 16, auto`
           : "auto",
          }}
    >
      {/* overlay */}
  ...
  <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-10 flex flex-col justify-center">
    <div className="grid md:grid-cols-2 items-center">
      ...
      <motion.div
        ...
        className="space-y-6 text-white ml-4 sm:ml-8 md:ml-12 lg:ml-16"
      >
