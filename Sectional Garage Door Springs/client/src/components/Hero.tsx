    ...
    <section id="hero" className="relative overflow-hidden scroll-mt-20">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 py-20 lg:py-32">
        ...
        >
          ...
          <br />
          <span className="text-red-500">Sectional Garage Door Springs</span>
        </motion.h1>
        ...
        >
          {phoneNumbers.map((phone, i) => (
            <motion.a
              ...
              className="flex flex-col items-center bg-red-500 hover:bg-red-600 text-white px-4 py-6 rounded-xl shadow-lg transform transition hover:scale-105"
