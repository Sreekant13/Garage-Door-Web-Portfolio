...
const phoneNumbers = [
  ...
  { number: "818-351-3118", area: "San Fernando" },
];

const brands = [
  { name: "La Canada", width: 110 },
  { name: "Flintridge", width: 110 },
  { name: "La Cresenta", width: 110 },
  { name: "Montrose", width: 110 },
  { name: "Glendale", width: 110 },
  { name: "Sunland", width: 110 },
  { name: "Pasadena", width: 110 },
  { name: "Burbank", width: 110 },
  { name: "Altadena", width: 110 },
];
...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative scroll-mt-20 min-h-[720px]" // ⬅️ give the hero some height
    >
      {/* Background Image */}
      <div className="absolute inset-0 -z-10">
        <img
          ...
          //                ^^^^^^^^^^^^^^^^^^
          // object-top shifts the visible part up so the composition
          // looks closer to the live site and less “zoomed”
        />
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 py-20 lg:py-32">
        ...
        >
          {brands.map((brand) => (
            <div
              key={brand.name}
              className="bg-white/20 px-5 py-2 rounded-lg shadow-md hover:scale-105 transform transition"
            >
        ...
        <motion.div
          className="mt-8 grid grid-cols-2 sm:grid-cols-2 gap-4 max-w-3xl w-full"
        ...
        >
          {phoneNumbers.map((phone, i) => (
            <motion.a
              ...
              className="flex flex-col items-center hover:bg-red-600 text-white px-4 py-6 rounded-xl shadow-lg transform transition hover:scale-105"
        ...
        {/* 🎉 Holiday card BELOW hero content, does not affect background */}
         <motion.div
         ...
         >
           <img
             ...
             className="rounded-2xl shadow-2xl max-w-md w-full border border-white/40"
           />
         </motion.div>
