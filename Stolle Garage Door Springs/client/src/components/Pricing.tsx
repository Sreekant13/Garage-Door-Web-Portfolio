      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 mb-4">
            Garage door sales, installation, repair and service in La Canada Flintridge, La Cresenta, Montrose, Glendale, Sunland, Pasadena, Altadena, Burbank is the only work we do and it's always performed professionally. Our team of garage door repairmen, specialize in the repair, maintenance, installation, and replacement of all types of garage doors. We deliver top of the line parts fast, friendly and on time. <strong>I give free price estimates on the phone and consultation.</strong>
          </p>
          <Button
            size="lg"
