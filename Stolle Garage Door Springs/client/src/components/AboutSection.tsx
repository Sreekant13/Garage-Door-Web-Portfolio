...
<div className="space-y-4 md:pr-8">
  ...
  <p className="text-gray-300">
    I am the company to turn to for garage door repair in La Canada Flintridge, La Cresenta, Montrose, Glendale, Sunland, Pasadena, Altadena, Burbank California. Over 47 years of experience in garage door repair and trouble shooting. I am a garage door repair company you can trust to repair, fix or replace your garage door, springs or opener!
  </p>
  <p className="text-gray-300">
      ...
      >
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center px-2 md:px-40 relative">
          ...
          <div className="space-y-4 md:pl-8">
            ...
            {/* Text */}
<p className="text-gray-300">
Call me Joseph Lucey. I offer emergency garage door repair service. After 47 years serving La Canada Flintridge, La Cresenta, Montrose, Glendale, Sunland, Pasadena, Altadena, Burbank California I am recognized by the <strong>SOUTHERN CALIFORNIA GARAGE DOOR NETWORK ASSOCATION</strong> as one of the best garage door repair companies serving La Canada, La Cresenta, Montrose, Glendale, Sunland, Pasadena, Altadena, Burbank California.
</p>
             <p className="text-gray-300">
              We provide all kinds of Garage door repair services. Anyone who has been to La Canada Flintridge, La Cresenta, Montrose, Glendale, Sunland, Pasadena, Altadena, Burbank California falls in love with these areas. And anyone who lives here knows that we have some of the best businesses around! We are glad to be recognized as one of them. Just ask anyone who has hired us in the past because we know that they will tell you, wonderful things.
            </p>
            {/*<p className="text-gray-300">
